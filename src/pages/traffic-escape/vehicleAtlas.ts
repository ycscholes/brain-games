...
const TRAFFIC_VEHICLE_ATLAS_SLOTS: Record<TrafficVehicleAppearance, TrafficVehicleAtlasSlotDefinition> = {
  ...
  "camper-rv": { column: 3, row: "three-cell", x: 2304, y: ATLAS_THREE_CELL_ROW_Y, width: 768, height: THREE_CELL_SLOT_HEIGHT, visibleBounds: { left: 48, top: 16, right: 720, bottom: 240 }, length: 3 },
  "tanker-truck": { column: 4, row: "three-cell", x: 3072, y: ATLAS_THREE_CELL_ROW_Y, width: 768, height: THREE_CELL_SLOT_HEIGHT, visibleBounds: { left: 64, top: 16, right: 704, bottom: 240 }, length: 3 },
};
...
export function getTrafficVehicleAtlasCropStyle(
  ...
  const yCorrection = measuredYCorrection;
