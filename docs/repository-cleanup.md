...
| `docs/superpowers/specs/2026-06-13-twenty-four-scoring-range-design.md` (`89a2a53`) | Same source/tests plus `docs/points-economy.md:23,76,247` | `5d04005`, `fe14e47`, `c4e6fec`; its only durable decision is fully extracted into the points document and page README; spec deleted. |
...
| `docs/superpowers/plans/2026-09-02-traffic-escape-navigation.md` (`c3f0549`) | `src/pages/traffic-escape/{index.tsx,navigation.ts}`, `tests/unit/trafficEscapeRun.test.ts`, `tests/unit/trafficEscapeGameLogic.test.ts` | `c3f0549`, `adb4021`; interrupted-run/back behavior is current in source and covered by the run/game regression suites; the navigation rationale remains in retained specs; plan deleted. |
