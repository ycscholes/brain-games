...
describe("trainingStorage", () => {
  ...
  describe("getAwardedPoints - aligned reward rates", () => {
    ...
    test("word-scramble, bird-count, color-trap, spatial-rotation, hidato, and tents-camp use 1x conversion with difficulty caps", () => {
      ...
      expect(getAwardedPoints("tents-camp", 34, "normal")).toBe(34);
      expect(getAwardedPoints("tents-camp", 40, "hard")).toBe(60);
    });
